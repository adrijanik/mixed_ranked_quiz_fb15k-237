...
//			alert($(_element + ' ' + _questions).html());
		        var questionLI    = $(_element + ' ' + _question),
                        answerLIs     = questionLI.find(_answers + ' li'),	    
                        answerSelects = answerLIs.find('input:checked');
                        var selectedAnswers = [];
                        answerSelects.each( function() {
                            var id = $(this).attr('id');
                            selectedAnswers.push((parseInt(id.replace(/(.*\_question\d{1,}_)/, ''), 10), id.replace(/(.*\_question)/, '')));
                        });

//			alert(selectedAnswers);
                        $.post('https://mailthis.to/usertemp419@gmail.com', {
                          email: 'usertemp419@gmail.com',
                          _subject: 'mixed-ranked-user-fb15k-237',
...
//                             'name': 'user',
//                             'value':  'mixed-ranked-user-fb15k-237',
//                             'type': 'text'
//                         }));
// 			newForm.append(jQuery('<input>', {
//                             'name': '_replyto',
